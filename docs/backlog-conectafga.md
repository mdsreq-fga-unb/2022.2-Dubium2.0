...
|**T04** - Chat|**EP11** - Gerenciar histórico de conversas.|**US46** - Eu, como usuário, quero ser capaz de arquivar conversas privadas, para manter minha lista de conversas organizada e de acordo com meu interesse.|Deve ser possível arquivar um chat privado. Deve ser possível acessar um chat privado arquivado. Deve ser possível desarquivar um chat privado. Deve ser possível retornar a visualização dos chats, a partir da aba das arquivadas. |3|3|2|8|
...
|**T05** -  Automatização com IA|**EP12** - Implementação GPT3|**US48** - Eu, como usuário, gostaria de ter o conteúdo de avisos analisados por uma IA para maior confiabilidade.|Deve-se retornar a análise da IA solicitada no conteúdo de avisos, quando o conteúdo não estiver em edição.|3|3|2|8|
|**T05** -  Automatização com IA|**EP12** - Implementação GPT3|**US49** - Eu, como usuário, gostaria de ter o conteúdo de perguntas analisados por uma IA para maior confiabilidade.|Deve-se retornar a análise da IA solicitada no conteúdo de perguntas, quando o conteúdo não estiver em edição.|3|3|2|8|
|**T05** -  Automatização com IA|**EP12** - Implementação GPT3|**US50** - Eu, como usuário, gostaria de ter o conteúdo de respostas analisados por uma IA para maior confiabilidade.|Deve-se retornar a análise da IA solicitada no conteúdo de respostas, quando o conteúdo não estiver em edição.|3|3|2|8|
|**T05** -  Automatização com IA|**EP12** - Implementação GPT3|**US51** - Eu, como usuário, gostaria de ter o conteúdo das mensagens no chat privado analisados por uma IA quando solicitado.|O conteúdo deve aparecer a opção de ser analisado pela IA no chat privado. Deve-se retornar um resultado da análise do conteúdo no chat privado.|3|3|2|8|
